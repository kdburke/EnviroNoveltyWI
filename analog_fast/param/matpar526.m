%Matpar526 sets parameters for analog runs, batch files 526

%%RUN COMMENTS HERE
%PRISM Climate aggregated to 4km level. 
%8 climate variables. 8 variables total

%July 2018

%homedir='/Users/kevinburke/Documents/Dissertation/WisconsinNovelty/Workshop/analog_fast/';    %location of analog program on mac
homedir='/Users/Kevin/Documents/Github/WisconsinNovelty/Workshop/analog_fast/';    %location of analog program on laptop
...
refdir='/Users/Kevin/Documents/Github/WisconsinNovelty/Workshop/analog_fast/input/';    %location of analog program on laptop
                                    %directory path (must have slash at
                                    %end!)
                                    
reffile='XXSEEBATCH.txt' 	%file name
REFKEY=[1]  			    %May be more than one.  Keyfield values, after sorting, must match ModClim. Must be a unique key for each sample
REFENTITY=[1];              %indicates subset of key fields  that identifies an entity (e.g. site/gridpoint).  Entities may have >1 sample.
REFCOORD=[2 3];			    %locations of spatial (x/y; lat/lon) coordinates
REFKEEPERS=[2 3]; 	%locations of fields for outputting, not used otherwise
REFVAR1=4; 				    %location of first climate variable	
...
tardir='/Users/Kevin/Documents/Github/WisconsinNovelty/Workshop/analog_fast/input/';    %location of analog program on laptop
                                    %directory path (must have slash at
                                    %end!)
                                    
tarfile='XXSEEBATCH.txt'             %file name
TARKEY=[1];                     %May be more than one.  Keyfield values do not have to match other files. 
TARENTITY=[1];                      %indicates subset of key fields that identifies an entity (e.g. site/gridpoint).  Entities may have >1 sample.
TARCOORD=[2 3];                     %locations of spatial (x/y; lat/lon) coordinates
TARKEEPERS=[2 3]; 	%locations of fields for outputting, not used otherwise
TARVAR1=4;                         %location of first climate variable	 
...
refdirclim='/Users/Kevin/Documents/Github/WisconsinNovelty/Workshop/analog_fast/input/';    %location of analog program on laptop
...
refdirsd='/Users/Kevin/Documents/Github/WisconsinNovelty/Workshop/analog_fast/input/';    %location of analog program on laptop

						        %directory path
reffilesd='XXSEEBATCH.txt'            %file name
REFSDKEY=[1];                   %locations of key fields.  May be more than one.  Keyfield values, after sorting, must match ModPoll. 
REFSD1=4;				        %locations of climate variables
