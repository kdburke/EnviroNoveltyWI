%Matpar527 sets parameters for analog runs, batch files 527

%%RUN COMMENTS HERE
%AGLU novelty for WI, aggregated to county level. 
%10 AGLU variables
% log transformed livestock and removed human pop
