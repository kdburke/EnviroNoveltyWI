%Matpar524 sets parameters for analog runs, batch files 524

%%RUN COMMENTS HERE
%PRISM Climate and ag novelty for WI, aggregated to county level. 
%8 climate variables. 11 ag/landuse variables, 15 veg variables. 38 variables total
%transformed livestock and human pop
