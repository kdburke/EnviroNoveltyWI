%Matpar517 sets parameters for analog runs, batch files 517

%%RUN COMMENTS HERE
%PRISM Climate and ag novelty for WI, aggregated to county level. 
%12 climate variables. 11 ag/landuse variables, 15 veg variables. 38 variables total
